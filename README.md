...
```text
 ...
 |          |                                                                  |
 |          v                                                                  |
 |  [ CatchFactory ] <--- Scans "Resources/ScriptableObjects/Fish/" on Start   |
 |          |                                                                  |
 |          v                                                                  |
 |  [ CatchDataCollection ] (Organizes fish by Layer 1..4)                     |
 |          |                                                                  |
 |          v (Random selection per Layer)                                     |
 |  [ Pond Spawner ] ---- Spawns prefab within [ WaterBounds Collider ]        |
 |          |                                                                  |
 |          v                                                                  |
 |  [ Fish (CatchBase) ] <--- Swimming AI & Animation (FishAnimator)           |
 |          |                                                                  |
 |     Player Casts & Buoy Attracts Fish                                       |
 |          |                                                                  |
 |          v                                                                  |
 |  [ Fishing Minigame ]                                                       |
 |          |                                                                  |
 ...
 |          |                                                                  |
 |          v                                                                  |
 |  [ Fish.Catch() ] ---> Destroy GameObject & notify Pond                     |
 |          |                                                                  |
 |          v                                                                  |
 |  [ GameHandle.cs ]                                                          |
 |    - Adds score with multiplier                                             |
 |    - Builds UDP Packets: ScoreEvent + SimpleEvent("fish_<Layer>")           |
 +-----------------------------------------------------------------------------+
                                       |
                                       | UDP Network (CrossoverNetcode)
                                       v
 +-----------------------------------------------------------------------------+
 |                       ARCADE CABINET (ArcadeDisplay)                        |
 |                                                                             |
 |  [ ArduinoListener.cs ] <--- Receives "fish_<Layer>"                        |
 |          |                                                                  |
 |          v                                                                  |
 |  [ PlayerInventory ]                                                        |
 |    - Layer 1 -> AddCommonFish()                                             |
 |    - Layer 2 -> AddRareFish()                                               |
 |    - Layer 3 -> AddEpicFish()                                               |
 |    - Layer 4 -> AddLegendaryFish()                                          |
 |          |                                                                  |
 |          v                                                                  |
 |  [ FishSellSystem & Shop ] ---> Redeems fish for Coins                      |
 |          |                                                                  |
 |          v                                                                  |
 |  [ Arduino / Coin Hopper ] ---> Dispenses physical tokens & drives LEDs    |
 +-----------------------------------------------------------------------------+
```
